...
```bash
$ git clone git@gitlab.com:uminho-di/li1/2223/2022li1g094.git
$ cd 2022li1g094
```
...
```bash
$ git clone https://gitlab.com/uminho-di/li1/2223/projetos/2022li1g094.git
$ cd 2022li1g094
```
...
- **A104528** Rodrigo da Silva de Sousa;
